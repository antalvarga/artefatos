    ...
    loop
      ...
      if MySum > MyCarneValor then
        ...
        -- Tratar alunos que, embora tenham direito a creditos, ja estão formados   
          ...
          dbms_output.put_line( MyMatricula || ';' || MySummary( 1 ).Description || ';' || MyCarne || ';' || cDM.Num_Seq_Debito_Mensalidade || ';' || MyAcordo );
        ...
        */
        ...
        -- Tratar Crédito para acerto de pagamento a maior   
          ...
          dbms_output.put_line( MyMatricula || '; 2-' || MySummary( 2 ).Description || ';' || MyCarne || ';' || cDM.Num_Seq_Debito_Mensalidade || ';' || MyAcordo );
        ...
        -- ou alterar a situacao_debito de 1 para 3.        
          ...
          dbms_output.put_line( MyMatricula || ';' || MySummary( 3 ).Description || ';' || MyCarne || ';' || cDM.Num_Seq_Debito_Mensalidade || ';' || MyAcordo );
        ...
        -- com os dados abaixo:         
          ...
          if MyReturn != 0 then
             -- Credito já existe   
             dbms_output.put_line( MyMatricula || ';' || 'CREDITO JA EXISTE' || ';' || MyCarne || ';' || cDM.Num_Seq_Debito_Mensalidade || ';' || MyAcordo );

          else           
            MySummary( 4 ).Summary := MySummary( 4 ).Summary + 1;        

            dbms_output.put_line( MyMatricula || ';' || MySummary( 4 ).Description || ';' || MyCarne || ';' || cDM.Num_Seq_Debito_Mensalidade || ';' || MyAcordo );
        ...
        */   
        ...
        --  '1','pendente', '2','baixado', 'cancelado'        
          ...
          dbms_output.put_line( MyMatricula || ';' || MySummary( 5 ).Description || ';' || MyCarne || ';' || cDM.Num_Seq_Debito_Mensalidade || ';' || MyAcordo );
          ...
          */                      
          ...
          if MyIndErro <> '0' then 
            ...
            if MyReturn != 0 then
              ...
              dbms_output.put_line( MyMatricula || ';' || MySummary( 6 ).Description || ';' || MyCarne || ';' || cDM.Num_Seq_Debito_Mensalidade || ';' || MyAcordo );
          ...
          dbms_output.put_line( MyMatricula || ';' || MySummary( 7 ).Description || ';' || MyCarne || ';' || cDM.Num_Seq_Debito_Mensalidade || ';' || MyAcordo );
